			...
			<ScrollView>
				<HStack alignItems="flex-start" space="4">
					...
					<VStack maxWidth="650px">
						...
						<Text>
							Need to generate text, image, video, or audio? Our no-cost
							self-service platform is great for educators, small businesses, or
							ML enthusiasts. Check out our current catalog of competitions for
							examples.
						</Text>
					</VStack>
				</HStack>
				<VStack space="6" mt="2">
					...
					<VStack space="3" maxW="650px">
						<VStack>
							...
							<Heading fontSize="14px">
								Explain what contestants will do. Make sure to include the goal
								of the competition, context, requirements evaluation process,
